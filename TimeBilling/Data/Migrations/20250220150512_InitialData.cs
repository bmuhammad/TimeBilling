...
namespace TimeBilling.Migrations
{
    /// <inheritdoc />
    public partial class InitialData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 220.0, "mary@timebilling.com", "img/mary.jpg", "Mary Jones" },
                    { 2, 85.0, "betty@timebilling.com", "img/betty.jpg", "Betty Patel" },
                    { 3, 115.0, "nancy@timebilling.com", "img/nancy.jpg", "Nancy Smith" },
                    { 4, 145.0, "john@timebilling.com", "img/john.jpg", "John Phillips" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 1, "Paintorama", "Phyllis", "555-2121" }
                });
        }
